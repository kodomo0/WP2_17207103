...
<form class="user" method="post" action="<?= base_url('index.php/autentifikasi/registrasi'); ?>">
...
<hr>
<div class="text-center">
<a class="small" href="<?=base_url('index.php/autentifikasi/lupaPassword'); ?>">Lupa Password?</a>
</div>
<div class="text-center">Sudah Menjadi Member?
    <a class="small"href="<?= base_url('index.php/autentifikasi'); ?>"> Login!</a>
</div>
</div>
</div>
</div>
